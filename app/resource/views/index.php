            ...
            <div class="row">
                <div class="col-12 text-white p-t-40 p-b-90">
                    ...
                    <h4 class=""> <span class="btn btn-white-translucent">
                            <i class="mdi mdi-format-text "></i></span> Cards
                    </h4>
                    <p class="opacity-75 ">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 m-b-30">
                ...
                <div class="card ">
                    <div class="card-media">
                        ...
                        <img class="card-img-top" src="assets/img/social/s21.jpg" alt="Card image cap">

                    </div>
                    <div class="card-body">
                        <h5 class="card-title">Image Controls</h5>
                        <p class="card-text">Example of controls over the thumb image above and below the thumb.
                        </p>
                        <a href="#" class="btn btn-primary">Go somewhere</a>
                    </div>
                </div>
            ...
            <div class="col-lg-4 m-b-30">
                <div class="card m-b-30 ">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Embedded Widget</h5>
                        <p class="card-text">Card with Embedded 3RD party widget using bootstraps embed
                            responsive
                            container.</p>
                ...
                <div class="card">
                    <div class="card-media">
                        ...
                        <img class="card-img-top" src="assets/img/social/s22.jpg" alt="Card image cap">
                    </div>
                    <div class="card-body text-white"
                        style="background-image: linear-gradient(-20deg, #2b5876 0%, #4e4376 100%);">
                        <h5 class="card-title">Card Gradient</h5>
                        <p class="card-text">Fancy card with a gradient background you can apply color gradient
                            card
                            body.</p>
                        <a href="#" class="btn btn-light">Go Anywhere</a>
                    </div>
